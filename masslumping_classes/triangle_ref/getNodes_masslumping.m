function [coords,ptrs,indices]=getNodes_masslumping(T,k)

% [coords,ptrs,indices]=getNodes_masslumping(T,k)
%
...
% We have change just the number of id that we want to return, since
% our triangle has id=(d+1)*(d+2)/2 + d-1 number of nodes
