function F = Load2_masslumping(T,fnf,fnk,g,h)

% F = Load2_masslumping(T,fnf,fnk,g,h)
%
%   Assembles the load vector for the problem
%
%          (d^2)u/(dt^2) - div(grad(u)) = f in Omega,
%                       u=g on Gamma_1,
%                   du/dn=h on Gamma_2.
%
...
id=round(d-1 + (d+2)*(d+1)/2); % +1 because 7 nodes
